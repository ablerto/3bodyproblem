...
// create planet copies
let planetcopies = [];
for (let i = 0; i < planets.length; i++) {
    if (i == 0) {
        planetcopies.push(new Planet(100,planets[i].mass,planets[i].color,planets[i].x+1,planets[i].y,planets[i].velocity))
    } else {
        planetcopies.push(new Planet(100,planets[i].mass,planets[i].color,planets[i].x,planets[i].y,planets[i].velocity))
    }
}
